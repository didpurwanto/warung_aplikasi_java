                ...
                <div id="loginBox">                
                    <form id="loginForm">
                        <fieldset id="body">
                            ...
                            <input type="submit" id="login" value="Sign in" />
                            <a href="register.html"><font color="#8b0000">Register</font></a>
                        </fieldset>
  ...
  <div id="main">
    ...
    <div id="content">
      <div class="products">
        <div class="cl">&nbsp;</div>
        <ul>
          <li> <a href="DetailProduk.html"><img src="resources/css/images/big1.jpg" alt="" /></a>
          ...
          <li> <a href="#"><img src="resources/css/images/big1.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LOREM IPSUM</h3>
              <div class="product-desc">
                <h4>WOMEN’S</h4>
          ...
          <li class="last"> <a href="#"><img src="resources/css/images/big1.jpg" alt="" /></a>
            <div class="product-info">
              <h3>LOREM IPSUM</h3>
              <div class="product-desc">
                <h4>WOMEN’S</h4>
